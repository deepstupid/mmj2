    ...
    SearchOptionsButtonHandler
{
    ...
    private String buildTitle() {
        ...
        if (args.theoremLabel != null)
            return SearchOptionsConstants.GENERAL_SEARCH_TITLE_LITERAL_1
                ...
                + SearchOptionsConstants.TITLE_LOC_AFTER_LITERAL
                + args.locAfterLabel;
        return args.generalSearchStmtLabel != null ? SearchOptionsConstants.GENERAL_SEARCH_TITLE_LITERAL_1
            + SearchOptionsConstants.TITLE_STMT_LITERAL
            + args.generalSearchStmtLabel : SearchOptionsConstants.GENERAL_SEARCH_TITLE_LITERAL_1
    ...
    abstract static class RequestGUI {
        abstract void doIt();
    }
