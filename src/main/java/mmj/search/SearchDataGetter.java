...
public class SearchDataGetter {
    ...
    {
        if (flag || flag2)
			return flag1 ? getComboFormulasStringArray() : getConclFormulasStringArray();
		return flag1 ? getLogHypFormulasStringArray() : new String[0];
    }
    ...
    {
        if (flag || flag2)
			return flag1 ? getComboLabelsStringArray() : getConclLabelsStringArray();
		return flag1 ? getLogHypLabelsStringArray() : new String[0];
    }
    ...
    public String[] getLabelsRPNAssrtDataStringArray(final boolean flag,
        final boolean flag1, final boolean flag2)
    {
		return flag2 ? getLabelsRPNStringArray() : new String[0];
    }
    ...
    private String getLabelRPNString() {
        if (labelRPNString == null) {
            ...
            final StringBuilder sb = new StringBuilder(5 * astmt.length);
            String s = "";
    ...
    {
        if (flag || flag2)
			return flag1 ? getComboFormulasVarHypArray() : getConclFormulasVarHypArray();
		return flag1 ? getLogHypFormulasVarHypArray() : new VarHyp[0][];
    }
    ...
    {
        if (flag || flag2)
			return flag1 ? getComboFormulasTreeArray() : getConclFormulasTreeArray();
		return flag1 ? getLogHypFormulasTreeArray() : new ParseTree[0];
    }
