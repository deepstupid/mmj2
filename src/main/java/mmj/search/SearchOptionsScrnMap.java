...
public class SearchOptionsScrnMap {
    ...
    {
		for (SearchOptionsScrnMapField searchOptionsScrnMapField : scrnMapField)
			if (!flag
				|| !SearchOptionsConstants.FIELD_ATTR[searchOptionsScrnMapField
				.getFieldId()].isSearchControl)
				searchOptionsScrnMapField.downloadToScrnMap(args, searchMgr);
