...
public class TheoremStmtGroup {
     ...
     */
    public static final Comparator<TheoremStmtGroup> SEQ = (o1, o2) -> o1.theorem.getSeq() - o2.theorem.getSeq();

    /**
     * NBR_LOG_HYP_SEQ sequences by number of LogHyps and Seq.
     */
    public static final Comparator<TheoremStmtGroup> NBR_LOG_HYP_SEQ = (o1, o2) -> {
        ...
        throws TheoremLoaderException
    {
        ...
        if (theoremLogHypArray.length == logHypArray.length)
            loopI:for (LogHyp hyp : theoremLogHypArray) {
                for (LogHyp logHyp : logHypArray)
                    if (logHyp == hyp)
                        continue loopI;
                match = false;
                break;
        ...
        final boolean appended)
    {
        ...
        if (maxExistingMObjRef != null) {
            ...
            seq = String.valueOf(maxExistingMObjRef.getSeq());
        }
