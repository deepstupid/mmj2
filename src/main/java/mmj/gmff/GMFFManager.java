...
public class GMFFManager {
            ...
            throws GMFFException
    {
        ...
        if (labelOrAsterisk.equals(GMFFConstants.OPTION_VALUE_ALL) || max > 1) {
            ...
            lowestNamePrefix = labelOrAsterisk.equals(GMFFConstants.OPTION_VALUE_ALL) ? "" : labelOrAsterisk;
        ...
        final ProofAsst proofAsst) throws GMFFException
    {
        ...
        if (labelOrAsterisk.equals(GMFFConstants.OPTION_VALUE_ALL) || max > 1) {
            ...
            String startTheorem;
            startTheorem = labelOrAsterisk.equals(GMFFConstants.OPTION_VALUE_ALL) ? null : labelOrAsterisk;
    ...
    private void updateExporterTypesetDefsList() {
        ...
        exporterLoop:
        for (GMFFExporter gmffExporter : gmffExporterList) {
            exporter = gmffExporter;
        ...
        throws GMFFException
    {
        ...
        userExportChoice = inputGMFFUserExportChoice == null ? GMFFConstants.DEFAULT_USER_EXPORT_CHOICE : inputGMFFUserExportChoice;
