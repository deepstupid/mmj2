...
public class BookManager implements TheoremLoaderCommitListener {
    ...
    private String[] chapterValues;
    private final String[][] sectionValues = null;
    private BitSet[] sectionDependencies;
    private BitSet[] chapterDependencies;
    private BitSet[] directSectionDependencies;
    private BitSet[] directChapterDependencies;
     ...
     */
    public static class SectionMObjIterator implements Iterator<MObj> {
        private int prevI;
        private int prevJ;
        private int nextI;
        private int nextJ;
    ...
    private int nextChapterNbr() {
        int chapterNbr;
        chapterNbr = currChapter == null ? 1 : currChapter.getChapterNbr() + 1;
        return chapterNbr;
    }
