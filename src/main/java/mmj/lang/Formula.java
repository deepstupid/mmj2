...
public class Formula {
    ...
    {
        assert constList == null || constList == null;
        ...
        constList = set.toArray(new Cnst[0]);
    }
    ...
    public VarHyp[] buildMandVarHypArray(final Hyp[] tempHypArray) {
        ...
        return hypList.toArray(new VarHyp[0]);
    }
        ...
        final int leftColContinuation, final int marginRight)
    {
        ...
        for (final Sym element : sym) {
            ...
            if (currCol > marginRight) {
                ...
                sb.append(" ".repeat(Math.max(0, currCol)));
            }
            sb.append(s);
            if (currCol < marginRight) {
                sb.append(' ');
