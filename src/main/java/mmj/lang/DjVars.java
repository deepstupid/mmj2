...
public class DjVars implements Comparable<DjVars> {
        ...
        final ScopeFrame mandFrame, final ScopeFrame optFrame)
    {
        ...
        for (Hyp value : hypArray) {
            if (!(value instanceof VarHyp))
                continue;
        ...
        final DjVars[] array2)
    {
        ...
        return mergedList.toArray(new DjVars[0]);
    }
...
//               ((DjVars)obj).toString()));
     ...
     * ASCII sort.
     */
    public static Comparator<? super Var> DV_ORDER = (Comparator<Var>) (o1, o2) -> {
     ...
     */
    public static Comparator<? super Var> DV_LEX = (Comparator<Var>) (o1, o2) -> o1.getId().compareTo(o2.getId());
}
