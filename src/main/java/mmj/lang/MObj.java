...
public abstract class MObj {
     ...
     */
    public static final Comparator<MObj> SEQ = (o1, o2) -> o1.seq - o2.seq;

    /**
     * SECTION_AND_MOBJ_NBR sequences by sectionNbr and sectionMObjNbr;
     */
    public static final Comparator<MObj> SECTION_AND_MOBJ_NBR = (o1, o2) -> o1.sectionNbr == o2.sectionNbr ? o1.sectionMObjNbr
