...
public class DerivationStep extends ProofStepStmt {
        ...
        final ProofStepStmt[] dArray)
    {
        ...
        for (int i = 0; i < dArray.length; i++) {
            ...
            if (outEnd - outIndex >= 0) System.arraycopy(outArray, outIndex, outArray, outIndex + 1, outEnd - outIndex);
        ...
        final List<WorkVar> generatedWorkVarList)
    {
        ...
        autoStep = auto;
        workVarList = generatedWorkVarList == null || generatedWorkVarList.isEmpty() ? null : generatedWorkVarList;
    ...
    private int parseHypField(final String hypField) {
        ...
        if (hypField != null && !hypField.isEmpty()) {
        ...
        setHypStepList(list.toArray(new String[0]));
