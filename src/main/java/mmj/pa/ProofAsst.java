...
public class ProofAsst implements TheoremLoaderCommitListener {
    ...
    private static class VolumeTestStats {
        public int nbrTestTheoremsProcessed;
        public int nbrTestNotProvedPerfectly;
        public int nbrTestProvedDifferently;
    }
    ...
    public List<Assrt> sortAssrtListForSearch(final List<Assrt> list) {
        ...
        sorted.sort(Assrt.NBR_LOG_HYP_SEQ);
        return sorted;
    }
    ...
    public void optimizeTheoremSearch() {
        ...
        final Comparator<Cnst> comp = (o1, o2) -> {
            ...
            return i1.intValue() != i2.intValue() ? i1 - i2 : o1.getSeq() - o2.getSeq();
        };
        ...
        final TheoremTestResult candidate)
    {
        ...
        final Comparator<TheoremTestResult> comp = (left, right) -> {
            if (left == right)
                return 0;
        ...
        final VolumeTestStats stats, final boolean printOkTheorems)
    {
        ...
        if (q != null) {
            RPNStep[] newProof;
            newProof = q.getProofTree() == null ? new RPNStep[0] : q.getProofTree().convertToRPNExpanded();
        ...
        final String theoremLabel, final StepSelectorResults results)
    {
        ...
        try {
            ...
            for (int i = 0; i < results.refArray.length; i++) {
                label = results.refArray[i] == null ? " " : results.refArray[i].getLabel();
    ...
    private List<Theorem> getSortedTheoremList(final int lowestMObjSeq) {
        ...
        sortedTheoremList.sort(MObj.SEQ);
