...
public interface LFTerm {
    ...
    class LFApply implements LFTerm {
    ...
    class LFLambda implements LFTerm {
    ...
    LFConst FORALL = new LFConst("forall");
    LFConst EXISTS = new LFConst("exists");
    LFConst EQUAL = new LFConst("equal");

    class LFConst implements LFTerm {
