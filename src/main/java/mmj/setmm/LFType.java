...
public interface LFType {
    ...
    class LFArrow implements LFType {
    ...
    LFType SET = new LFTypeConst("term");
    LFType PROP = new LFTypeConst("prop");
    LFType CLASS = new LFTypeConst("class");
    // new LFArrow(SET, PROP);

    class LFTypeConst implements LFType {
