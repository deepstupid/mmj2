...
public class Grammar implements SyntaxVerifier {
     ...
     */
    private final int parseTreeMax;
...
//  private     Set     baseGRSet;
    ...
    private int lastGrammarRuleNbr;
        ...
        throws VerifyException
    {
        ...
        // faster, takes first parse
        parseTreeMax = doCompleteStmtAmbiguityEdits ? GrammarConstants.PARSE_TREE_MAX_FOR_AMBIG_EDIT : 1;
...
//  }
    ...
    private boolean initializeGrammarTables() {
        ...
        } catch (final InstantiationException | SecurityException | NoSuchMethodException | InvocationTargetException | IllegalAccessException e) {
