...
public abstract class GrammarRule implements Comparable<GrammarRule> {
     ...
     */
    public static final Comparator<GrammarRule> RULE_NBR = (o1, o2) -> o1.ruleNbr - o2.ruleNbr;

    /**
     * MAX_SEQ_NBR sequences by GrammarRule.maxSeqNbr & ruleNbr
     */
    public static final Comparator<GrammarRule> MAX_SEQ_NBR = (o1, o2) -> {
...
//      grammar.baseGRSetAdd(baseRule);
    ...
    public Cnst getRuleFormatExprFirst() {
        return ruleFormatExpr.length > 0 ? ruleFormatExpr[0] : null;
    }
    ...
    public Cnst getRuleFormatExprIthSymbol(final int i) {
        return i > ruleFormatExpr.length ? null : ruleFormatExpr[i - 1];
    }
