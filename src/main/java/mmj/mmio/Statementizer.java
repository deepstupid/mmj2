...
public class Statementizer implements Closeable {
    ...
    private String validateNextTokenLabel() throws MMIOException {
    ...
    private void getComment(final SrcStmt x) throws MMIOException, IOException {
        ...
        while (true) {
            ...
            if (getNextToken() > 0) {
                 ...
                 */
                if (!workToken.contains(MMIOConstants.MM_END_COMMENT_KEYWORD)
                    && !workToken.contains(MMIOConstants.MM_BEGIN_COMMENT_KEYWORD))
                    continue;
