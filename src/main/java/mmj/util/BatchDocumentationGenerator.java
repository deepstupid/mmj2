 ...
 */
public enum BatchDocumentationGenerator {
	;
        ...
        throws FileNotFoundException
    {
        ...
        for (int index = 0; index < commandList.length; index++) {
            ...
            documentation.append("<a href=\"#command").append(String.valueOf(index));
        ...
        for (int index = 0; index < commandList.length; index++) {
            ...
            documentation.append(String.valueOf(index)).append("\">");
            documentation.append(commandList[index].name());
