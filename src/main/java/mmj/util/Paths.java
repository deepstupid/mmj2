...
public class Paths {
            ...
            throws MMJException, IOException
    {
        ...
        // mmj2 path
		s = mmj2PathArgument == null ? null : new File(mmj2PathArgument).getAbsolutePath();
        ...
        // metamath path
		s = metamathPathArgument == null ? null : new File(metamathPathArgument).getAbsolutePath();
        ...
        // svc path
		s = svcPathArgument == null ? null : new File(svcPathArgument).getAbsolutePath();
