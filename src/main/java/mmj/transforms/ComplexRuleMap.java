...
public abstract class ComplexRuleMap<Data> {
    ...
    {
        Map<ConstSubst, Map<PropertyTemplate, Data>> substMap = map.computeIfAbsent(stmt, k -> new HashMap<>());

        Map<PropertyTemplate, Data> propertyMap = substMap.computeIfAbsent(constSubst, k -> new HashMap<>());
