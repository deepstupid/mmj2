...
public class ClosureInfo extends DBInfo {
    ...
    public static class ResultClosureInfo {
        ...
        for (final PropertyTemplate template : possibleProperties) {
            ...
            if (core != null) {
                ...
                if (core.toString().equals("c1")
                    ...
                    core.toString();
                */
                Map<ParseNodeHashElem, Assrt> cMap = constInfo.computeIfAbsent(template, k -> new HashMap<>());
                        ...
                        final GenProofStepStmt[] hyps, final Assrt assrt)
                    {
                        ...
                        final GenProofStepStmt hypGenStep = conjInfo
                            .concatenateInTheSamePattern(hyps, hypsPartPattern,
                                info);
                        assert !hypGenStep.hasPrefix() || clRes == ClosureResult.USED_PREFIX_RULE;
    ...
    private interface CreateClosureVisitor {
        ClosureComplexRuleMap getMap();
        GenProofStepStmt createClosureStep(final GenProofStepStmt[] hyps,
                                           final Assrt assrt);
    }
    ...
    public enum ClosureResult {
        ...
        ClosureResult(final boolean hasClosure, final int num) {
    ...
    {
        return preferred.num <= other.num ? preferred : other;
    }
    ...
    public boolean performClosureTransformation(final WorksheetInfo info) {
        ...
        if (extrImplRes != null) {
            ...
            return performClosureTransformationInternal(info, extrImplRes.core);
        }
