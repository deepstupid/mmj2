...
public class AssocComTransformation extends Transformation {
    ...
    public ParseNode getCanonicalNode(final WorksheetInfo info) {
        ...
        helper.operandList.sort((o1, o2) -> CommutativeInfo.compareNodes(o1, o2));
    ...
    private class ACTree {
            ...
            final ACTree right)
        {
            ...
            Arrays.sort(leafs, (o1, o2) -> Integer.compare(o1.num, o2.num));
        ...
        public void replaceNode(final ParseNode newNode) {
            assert !validParseNode : "We should replace something "
    ...
    private class CanonicalInfo {
        ...
        public String toString() {
            ...
            if (next != null)
                nextStr = next.index != null ? ", next " + next.index.toString() : ", next ...";
        ...
        final ParseNode topNode, final AssocTree assocTree)
    {
        ...
        resList.sort((o1, o2) -> CommutativeInfo.compareNodes(o1.canonical, o2.canonical));
        ...
        final WorksheetInfo info, ACTree myTree, final ACTree tgtTree)
    {
        ...
        final int startSide;
        startSide = tgtTree.children[0].leafsLength() >= tgtTree.children[1]
            .leafsLength() ? 0 : 1;
