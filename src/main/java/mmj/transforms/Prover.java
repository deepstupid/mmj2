...
public interface Prover {
     ...
     */
    ProverResult prove(WorksheetInfo info, ParseNode root);
     ...
     * @author Mario
     */
    abstract class AssrtProver implements Prover {
        public Assrt assrt;
     ...
     * @author Mario
     */
    abstract class HypProver extends AssrtProver {
     ...
     * @author Mario
     */
    class HypProverResult extends ProverResult {
        public VarHyp[] vars;
